...
<table>
  <tr>
    <td><img width="720" height="1143" alt="Screenshot_20240723-211702_Instagram" src="https://github.com/user-attachments/assets/e00f8d0b-ff9b-44e9-bc33-59c74b0f8091" /></td>
    <td><img width="720" height="933" alt="Screenshot_20240624-102752_Instagram" src="https://github.com/user-attachments/assets/0823ea96-af60-4d87-b0e0-14eda1eec12d" /></td>
    <td><img width="720" height="866" alt="Screenshot_20240625-131737_Instagram" src="https://github.com/user-attachments/assets/4ca81d05-d5b6-49be-a5ac-173587cfb8e4" /></td>
  </tr>
</table>
...
<table>
  <tr>
    <td><img width="550" height="550" alt="unnamed" src="https://github.com/user-attachments/assets/90476646-e892-47ef-bce1-63350b0331ff" /></td>
    <td><img width="720" height="896" alt="Screenshot_20241219-213230_Instagram" src="https://github.com/user-attachments/assets/55edbe41-a775-4d09-8f40-86101a25ba41" /></td>
    <td><img width="1100" height="1100" alt="unnamed" src="https://github.com/user-attachments/assets/eea514b8-f209-4fc7-bc5f-3cbf01bff134" /></td>
  </tr>
</table>

<img width="720" height="906" alt="Screenshot_20231205-142835_Instagram" src="https://github.com/user-attachments/assets/49fe0b54-088a-47ca-8cc7-8dacc801ba15" />
...
Software Antivírus: Programas projetados para detectar e remover <a href="https://youtu.be/8u7fV4zrYBQ">malware</a>.
...
<img width="720" height="924" alt="Screenshot_20241117-182641_YouTube" src="https://github.com/user-attachments/assets/aed9d322-ec29-4e7f-b31f-495a44dc883b" />
...
<img width="550" height="670" alt="unnamed" src="https://github.com/user-attachments/assets/72bab8ce-fd54-48eb-a7e7-aab598a044be" />
...
O Red Team é a equipe de segurança que atua como adversária e realiza testes de penetração para identificar fraquezas em um sistema. A engenharia reversa é uma técnica comum usada pelo "Red Team" para entender como os atacantes podem explorar vulnerabilidades e criar contramedidas eficazes. Basicamente útil para criar crackers de programas originais de licença paga.
...
# [Red Team] Spoofing
Spoofing é a técnica de falsificar uma identidade ou origem para enganar sistemas ou pessoas, fazendo parecer que uma comunicação vem de uma fonte confiável quando na verdade vem do atacante.

**IP Spoofing** é a forma mais clássica. O atacante forja o endereço IP de origem nos pacotes que envia, fazendo parecer que o tráfego vem de outro endereço. É muito usado em ataques DDoS de reflexão, onde o atacante manda requisições com o IP da vítima como origem, fazendo servidores de terceiros responderem para a vítima com tráfego amplificado.

**ARP Spoofing** acontece na rede local. O atacante manda respostas ARP falsas associando o seu MAC address ao IP de outro dispositivo, geralmente o gateway. Com isso ele se posiciona no meio da comunicação, um ataque clássico de Man-in-the-Middle, interceptando e podendo modificar todo o tráfego que passa pela rede.

**DNS Spoofing** é quando o atacante corrompe o cache de um servidor DNS ou intercepta consultas DNS, respondendo com endereços IP falsos. A vítima digita um endereço legítimo mas é redirecionada para um servidor malicioso, muito usado para phishing sofisticado.

**Email Spoofing** é a falsificação do remetente de um email. Como o protocolo SMTP por padrão não autentica quem está enviando, é possível forjar o campo "From" para se passar por qualquer pessoa ou empresa. É a base de ataques de engenharia social e phishing direcionado.

**MAC Spoofing** é a alteração do endereço MAC da interface de rede para se passar por outro dispositivo, podendo bypassar filtros de controle de acesso baseados em MAC address.

Em contexto de red team, spoofing é amplamente usado na fase de reconhecimento e movimentação lateral, especialmente ARP spoofing para capturar credenciais em texto plano dentro de redes corporativas que ainda usam protocolos sem criptografia.
